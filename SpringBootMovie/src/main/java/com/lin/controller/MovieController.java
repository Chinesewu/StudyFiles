...
public class MovieController {
    ...
    /**
     * 生成上一部和下一部电影的代码
     * @param lastMovie 上一部电影
     * @param nextMovie 下一部电影
     * @return 上一部和下一部电影的代码
     */
    private String generateUpAndDownPageCode(Movie lastMovie, Movie nextMovie) {
        ...
        if (lastMovie == null || lastMovie.getId() == null) {
            ...
            pageCode.append(String.format("<p>上一部：<a href='/movie/%s'>%s</a></p>", lastMovie.getId(), lastMovie.getTitle()));
        }
        if (nextMovie == null || nextMovie.getId() == null) {
            pageCode.append("<p>下一部：没有了</p>");
        } else {
            pageCode.append(String.format("<p>下一部：<a href='/movie/%s'>%s</a></p>", nextMovie.getId(), nextMovie.getTitle()));
        }
